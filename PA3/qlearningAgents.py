...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        scores = [self.getQValue(state, action) for action in legalMoves]
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        self.val[(state, action)] = self.getQValue(state, action) + (self.alpha * (reward +
                                                                                   (
